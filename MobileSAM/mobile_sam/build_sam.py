...
# build only the prompt encoder and mask decoder
def build_sam_no_image_encoder(checkpoint=None):
    return _build_sam_no_image_encoder(
        checkpoint=checkpoint,
    )
...
sam_model_registry = {
    ...
    "no_image_encoder": build_sam_no_image_encoder
}
...
# credit [SurgicalSAM](https://github.com/wenxi-yue/SurgicalSAM/blob/eeef4a906692eed516584b4c150bb6ef101ceda5/segment_anything/build_sam.py)
def _build_sam_no_image_encoder(
    checkpoint=None,
):
    prompt_embed_dim = 256
    image_size = 1024
